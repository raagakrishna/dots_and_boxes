...
sudo nohup java -jar ./server/target/dots_boxes-1.0-SNAPSHOT-jar-with-dependencies.jar &
sudo nohup java -jar ./resource_server/target/dots_boxes-1.0-SNAPSHOT-jar-with-dependencies.jar &
